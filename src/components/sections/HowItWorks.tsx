                ...
                <div key={step.title} className="relative flex items-center">
                  ...
                  >
                    ...
                    <div className="flex-1">
                      <h3 className="font-bold text-base sm:text-xl text-gray-700 mb-1 sm:mb-2">{step.title}</h3>
                      <p className="text-gray-700 text-sm sm:text-base text-left m-0">{step.desc}</p>
                    </div>
                  </div>
                </div>
              ))}
