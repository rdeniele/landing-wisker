...
function Hero() {
  ...
  return (
    <section className="w-full rounded-3xl mx-auto py-8 sm:py-12 md:py-16 px-2 sm:px-4 md:px-6 lg:px-8">
      <div className="w-full flex flex-col lg:flex-row items-start justify-between mt-6 sm:mt-10 md:mt-20 mb-6 sm:mb-10 md:mb-20 gap-6 sm:gap-8" id="hero">
        {/* Left Column */}
        <div className="flex-1 flex flex-col items-start justify-start text-left">
          ...
          <p className="mt-4 sm:mt-6 text-gray-700 w-full text-left text-base sm:text-lg leading-relaxed mb-0">
            <span className="font-extrabold text-orange-300">Study magic, zero panic.</span> Wisker turns your notes into quizzes, flashcards, and study plans—fast. Less stress, more wins.
          </p>
          {/* CTA buttons */}
          ...
          <div className="flex flex-row flex-wrap gap-6 mt-6 sm:mt-8 w-full justify-start">
            <div className="flex flex-col items-start">
              <span className="text-2xl sm:text-3xl font-extrabold text-orange-300">1,200+</span>
              <span className="text-gray-700 text-sm sm:text-base font-semibold">Students helped</span>
            </div>
            <div className="flex flex-col items-start">
              <span className="text-2xl sm:text-3xl font-extrabold text-blue-400">3,400+</span>
              <span className="text-gray-700 text-sm sm:text-base font-semibold">Quizzes generated</span>
            </div>
            <div className="flex flex-col items-start">
              <span className="text-2xl sm:text-3xl font-extrabold text-purple-400">7,800+</span>
              <span className="text-gray-700 text-sm sm:text-base font-semibold">Flashcards created</span>
            </div>
          </div>
        </div>
